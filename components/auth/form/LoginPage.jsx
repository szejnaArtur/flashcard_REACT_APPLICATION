...
const LoginPage = ({click}) => {
    ...
    const loginClicked = () => {
        AuthenticationService
            ...
            .then(
                (response) => {
                    AuthenticationService.registerSuccessfulLoginForJwt(email, response.data.access_token);
                    click(AuthenticationService.isUserLoggedIn);
    ...
    const showToast = () => {
        if (showSuccessMessage){
            if (hasLoginFailed){
                return <SimpleToastFail click={setShowSuccessMessage} message='Logged fail.' />
            } else {
                return <SimpleToastSuccess click={setShowSuccessMessage} message='Logged success.' />
            }
        }
        return null;
    }
